      ...
      <div className="ocean-flow">
        ...
        <div className="effect-background">
          <img
            ...
            alt="Kapal"
            className={`ocean-flow-1 ${
              isImageVisible ? "fade-in" : "fade-out"
            }`}
          />

          <h1
            className={`ocean-flow-1-title ${
              isImageVisible ? "fade-in" : "fade-out"
            }`}
          >
            OCEAN FLOW I
        ...
        <div className="floating-terminal2">
          ...
          <img src="/Assets/oceanflow1.jpg" alt="oceanflow1" className="oc-1" />
          <img src="/Assets/oceanflow2.jpg" alt="oceanflow2" className="oc-2" />
          <img src="/Assets/oceanflow3.jpg" alt="oceanflow3" className="oc-3" />
