  ...
  return (
    <div className="padmasari">
      ...
      <div className="floating-terminal2">
        ...
        <div className="no-border-row">TB PRIME 1600 HP SPECIFICATION</div>
        ...
        <div className="no-border-row-2">TB PRIME 1300 HP SPECIFICATION</div>
        <div className="specification-table-wrapper">
          <table className="specification-table">
            <thead>
              <tr>
        ...
        <div className="no-border-row-3">BG SUPPORT 300 FEET SPECIFICATION</div>
        <div className="specification-table-wrapper">
          <table className="specification-table">
            <thead>
              <tr>
        ...
        <div className="no-border-row-4">BG SUPPORT 270 FEET SPECIFICATION</div>
        <div className="specification-table-wrapper">
          <table className="specification-table">
            <thead>
              <tr>
